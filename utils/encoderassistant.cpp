...
const QString EncoderAssistant::pattern(const EncoderAssistant::Encoder encoder, const Parameters &parameters)
{
    ...
    case EncoderAssistant::OGGENC: {
        ...
        cmd +=
            QString::fromUtf8(" -c \"Artist=$" VAR_TRACK_ARTIST "\" -c \"Title=$" VAR_TRACK_TITLE "\" -c \"Album=$" VAR_ALBUM_TITLE "\" -c \"Date=$" VAR_DATE "\" -c \"Tracknumber=$" VAR_TRACK_NO "\" -c \"Genre=$" VAR_GENRE "\" ${" VAR_CD_NO
                              " pre=\"-c Discnumber=\"}"
