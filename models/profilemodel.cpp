...
QVariant ProfileModel::data(const QModelIndex &index, int role) const
{
    ...
    if ((role == Qt::DisplayRole) || (role == Qt::EditRole)) {
        ...
        case PROFILE_MODEL_COLUMN_PROFILEINDEX_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_PROFILEINDEX_KEY];
        case PROFILE_MODEL_COLUMN_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_NAME_KEY];
        case PROFILE_MODEL_COLUMN_ICON_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_ICON_KEY];

        case PROFILE_MODEL_COLUMN_ENCODER_SELECTED_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_ENCODER_SELECTED_KEY];

        case PROFILE_MODEL_COLUMN_SCHEME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SCHEME_KEY];
        case PROFILE_MODEL_COLUMN_FAT32COMPATIBLE_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_FAT32COMPATIBLE_KEY];
        case PROFILE_MODEL_COLUMN_UNDERSCORE_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_UNDERSCORE_KEY];
        case PROFILE_MODEL_COLUMN_2DIGITSTRACKNUM_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_2DIGITSTRACKNUM_KEY];
        case PROFILE_MODEL_COLUMN_SC_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SC_KEY];
        case PROFILE_MODEL_COLUMN_SC_SCALE_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SC_SCALE_KEY];
        case PROFILE_MODEL_COLUMN_SC_SIZE_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SC_SIZE_KEY];
        case PROFILE_MODEL_COLUMN_SC_FORMAT_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SC_FORMAT_KEY];
        case PROFILE_MODEL_COLUMN_SC_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SC_NAME_KEY];
        case PROFILE_MODEL_COLUMN_PL_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_PL_KEY];
        case PROFILE_MODEL_COLUMN_PL_FORMAT_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_PL_FORMAT_KEY];
        case PROFILE_MODEL_COLUMN_PL_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_PL_NAME_KEY];
        case PROFILE_MODEL_COLUMN_PL_ABS_FILE_PATH_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_PL_ABS_FILE_PATH_KEY];
        case PROFILE_MODEL_COLUMN_PL_UTF8_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_PL_UTF8_KEY];
        case PROFILE_MODEL_COLUMN_INF_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_INF_KEY];
        case PROFILE_MODEL_COLUMN_INF_TEXT_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_INF_TEXT_KEY];
        case PROFILE_MODEL_COLUMN_INF_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_INF_NAME_KEY];
        case PROFILE_MODEL_COLUMN_INF_SUFFIX_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_INF_SUFFIX_KEY];
        case PROFILE_MODEL_COLUMN_HL_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_HL_KEY];
        case PROFILE_MODEL_COLUMN_HL_FORMAT_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_HL_FORMAT_KEY];
        case PROFILE_MODEL_COLUMN_HL_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_HL_NAME_KEY];
        case PROFILE_MODEL_COLUMN_CUE_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_CUE_KEY];
        case PROFILE_MODEL_COLUMN_CUE_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_CUE_NAME_KEY];
        case PROFILE_MODEL_COLUMN_CUE_ADD_MCN_AND_ISRC_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_CUE_ADD_MCN_AND_ISRC_KEY];
        case PROFILE_MODEL_COLUMN_LOG_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_LOG_KEY];
        case PROFILE_MODEL_COLUMN_LOG_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_LOG_NAME_KEY];
        case PROFILE_MODEL_COLUMN_LOG_WRITE_TIMESTAMPS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_LOG_WRITE_TIMESTAMPS_KEY];
        case PROFILE_MODEL_COLUMN_SF_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SF_KEY];
        case PROFILE_MODEL_COLUMN_SF_NAME_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_SF_NAME_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_LAME_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_LAME_PARAMETERS_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_OGGENC_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_OGGENC_PARAMETERS_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_OPUSENC_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_OPUSENC_PARAMETERS_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_FLAC_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_FLAC_PARAMETERS_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_FAAC_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_FAAC_PARAMETERS_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_WAVE_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_WAVE_PARAMETERS_KEY];
        case PROFILE_MODEL_COLUMN_ENCODER_CUSTOM_PARAMETERS_INDEX:
            return cache.at(index.row())[PROFILE_MODEL_COLUMN_ENCODER_CUSTOM_PARAMETERS_KEY];
        }
    }
...
bool ProfileModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        switch (index.column()) {
        case PROFILE_MODEL_COLUMN_PROFILEINDEX_INDEX:
            cache[index.row()][PROFILE_MODEL_PROFILEINDEX_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_NAME_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ICON_INDEX:
            cache[index.row()][PROFILE_MODEL_ICON_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_SELECTED_INDEX:
            cache[index.row()][PROFILE_MODEL_ENCODER_SELECTED_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_SCHEME_INDEX:
            cache[index.row()][PROFILE_MODEL_SCHEME_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_FAT32COMPATIBLE_INDEX:
            cache[index.row()][PROFILE_MODEL_FAT32COMPATIBLE_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_UNDERSCORE_INDEX:
            cache[index.row()][PROFILE_MODEL_UNDERSCORE_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_2DIGITSTRACKNUM_INDEX:
            cache[index.row()][PROFILE_MODEL_2DIGITSTRACKNUM_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_SC_INDEX:
            cache[index.row()][PROFILE_MODEL_SC_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_SC_SCALE_INDEX:
            cache[index.row()][PROFILE_MODEL_SC_SCALE_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_SC_SIZE_INDEX:
            cache[index.row()][PROFILE_MODEL_SC_SIZE_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_SC_FORMAT_INDEX:
            cache[index.row()][PROFILE_MODEL_SC_FORMAT_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_SC_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_SC_NAME_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_PL_INDEX:
            cache[index.row()][PROFILE_MODEL_PL_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_PL_FORMAT_INDEX:
            cache[index.row()][PROFILE_MODEL_PL_FORMAT_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_PL_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_PL_NAME_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_PL_ABS_FILE_PATH_INDEX:
            cache[index.row()][PROFILE_MODEL_PL_ABS_FILE_PATH_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_PL_UTF8_INDEX:
            cache[index.row()][PROFILE_MODEL_PL_UTF8_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_INF_INDEX:
            cache[index.row()][PROFILE_MODEL_INF_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_INF_TEXT_INDEX:
            cache[index.row()][PROFILE_MODEL_INF_TEXT_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_INF_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_INF_NAME_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_INF_SUFFIX_INDEX:
            cache[index.row()][PROFILE_MODEL_INF_SUFFIX_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_HL_INDEX:
            cache[index.row()][PROFILE_MODEL_HL_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_HL_FORMAT_INDEX:
            cache[index.row()][PROFILE_MODEL_HL_FORMAT_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_HL_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_HL_NAME_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_CUE_INDEX:
            cache[index.row()][PROFILE_MODEL_CUE_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_CUE_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_CUE_NAME_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_CUE_ADD_MCN_AND_ISRC_INDEX:
            cache[index.row()][PROFILE_MODEL_CUE_ADD_MCN_AND_ISRC_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_LOG_INDEX:
            cache[index.row()][PROFILE_MODEL_LOG_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_LOG_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_LOG_NAME_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_LOG_WRITE_TIMESTAMPS_INDEX:
            cache[index.row()][PROFILE_MODEL_LOG_WRITE_TIMESTAMPS_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_SF_INDEX:
            cache[index.row()][PROFILE_MODEL_SF_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_SF_NAME_INDEX:
            cache[index.row()][PROFILE_MODEL_SF_NAME_KEY] = value;
            break;

        case PROFILE_MODEL_COLUMN_ENCODER_LAME_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_LAME_PARAMETERS_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_OGGENC_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_OGGENC_PARAMETERS_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_OPUSENC_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_OPUSENC_PARAMETERS_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_FLAC_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_FLAC_PARAMETERS_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_FAAC_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_FAAC_PARAMETERS_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_WAVE_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_WAVE_PARAMETERS_KEY] = value;
            break;
        case PROFILE_MODEL_COLUMN_ENCODER_CUSTOM_PARAMETERS_INDEX:
            cache[index.row()][PROFILE_MODEL_COLUMN_ENCODER_CUSTOM_PARAMETERS_KEY] = value;
            break;
    ...
    error = Message(i18n("Unknown error. No index found in profile model."), Message::ERROR, 0, i18n("This is an internal error. Please report."));
...
bool ProfileModel::insertRows(int row, int count, const QModelIndex &parent)
{
    ...
    if (row == cache.count())
        for (int i = 0; i < count; ++i)
            cache.append(new_profile());
    else
        for (int i = row; i < count; ++i)
            cache.insert(i, new_profile());
...
bool ProfileModel::validateData(const QModelIndex &index, const QVariant &value)
{
    ...
    case PROFILE_MODEL_COLUMN_NAME_INDEX: {
        if (value.toString().isEmpty()) {
            error = Message(i18n("Profile name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the profile. Please set one."));
            return false;
        }
        ...
        for (int i = 0; i < cache.count(); ++i) {
            if (i == index.row())
                continue;
            if (value.toString() == cache.at(i)[PROFILE_MODEL_NAME_KEY].toString()) {
                found = true;
                break;
            }
        }
        if (found) {
            error = Message(i18n("Profile name already exists."),
                            Message::ERROR, 0,
    ...
    case PROFILE_MODEL_COLUMN_ENCODER_SELECTED_INDEX:
        if (value.toInt() == -1) {
            error = Message(i18n("Profile encoder is not defined."), Message::ERROR, 0, i18n("You have given no encoder for the profile. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_SCHEME_INDEX:
        if (value.toString().isEmpty()) {
            error = Message(i18n("Profile filename scheme is not defined."),
                            Message::ERROR, 0,
    ...
    case PROFILE_MODEL_COLUMN_SC_FORMAT_INDEX:
        if ((value.toString() != "JPEG") && (value.toString() != "JPG") && (value.toString() != "PNG") && (value.toString() != "TIFF")
            ...
            error = Message(i18n("The image file format is unknown."),
                            Message::ERROR, 0,
    ...
    case PROFILE_MODEL_COLUMN_SC_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error = Message(i18n("Cover name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the cover. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_PL_FORMAT_INDEX:
        if ((value.toString() != "M3U") && (value.toString() != "PLS") && (value.toString() != "XSPF")) {
            error = Message(i18n("The playlist file format is unknown."),
                            Message::ERROR, 0,
    ...
    case PROFILE_MODEL_COLUMN_PL_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error = Message(i18n("Playlist name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the playlist. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_INF_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error =
                Message(i18n("Info text name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the info text file. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_INF_SUFFIX_INDEX:
        if (value.toString().isEmpty()) {
            error = Message(i18n("Info text file name suffix must not be empty."),
                            Message::ERROR, 0,
    ...
    case PROFILE_MODEL_COLUMN_HL_FORMAT_INDEX:
        if ((value.toString() != "SFV") && (value.toString() != "MD5") && (value.toString() != "SHA-256")) {
            error = Message(i18n("The hashlist file format is unknown."),
                            Message::ERROR, 0,
    ...
    case PROFILE_MODEL_COLUMN_HL_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error = Message(i18n("Hashlist name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the hashlist. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_CUE_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error =
                Message(i18n("Cue filename name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the cue sheet. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_LOG_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error = Message(i18n("Log filename name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the log file. Please set one."));
            return false;
        }
        break;
    ...
    case PROFILE_MODEL_COLUMN_SF_NAME_INDEX:
        if (value.toString().isEmpty()) {
            error =
                Message(i18n("Filename name must not be empty."), Message::ERROR, 0, i18n("You have given no name for the single audio file. Please set one."));
            return false;
        }
        break;
...
{
    for (int i = 0; i < cache.count(); ++i)
        if (profile_index == cache.at(i)[PROFILE_MODEL_PROFILEINDEX_KEY].toInt())
            return i;
    return -1;
}
...
{
    for (int j = 0; j < cache.count(); ++j)
        if (profile_index == cache.at(j)[PROFILE_MODEL_PROFILEINDEX_KEY].toInt())
            return true;
...
{
    beginResetModel();
    std::sort(cache.begin(), cache.end(), lessThan);
    endResetModel();
    Q_EMIT profilesRemovedOrInserted();
}
...
Message ProfileModel::lastError() const
{
    return error;
}
...
const Profile ProfileModel::new_profile()
{
    Profile p;
...
void ProfileModel::new_name(QString &name)
{
    for (int j = 0; j < cache.count(); ++j)
        if (name == cache.at(j)[PROFILE_MODEL_NAME_KEY].toString()) {
...
void ProfileModel::save(KConfig *config)
{
    ...
    for (int i = 0; i < cache.count(); ++i) {
        ...
        subGroup.writeEntry(PROFILE_MODEL_SCHEME_KEY, cache[i][PROFILE_MODEL_SCHEME_KEY]);
        ...
        subGroup.writeEntry(PROFILE_MODEL_PL_ABS_FILE_PATH_KEY, cache[i][PROFILE_MODEL_PL_ABS_FILE_PATH_KEY]);
        subGroup.writeEntry(PROFILE_MODEL_PL_UTF8_KEY, cache[i][PROFILE_MODEL_PL_UTF8_KEY]);
        ...
        subGroup.writeEntry(PROFILE_MODEL_CUE_ADD_MCN_AND_ISRC_KEY, cache[i][PROFILE_MODEL_CUE_ADD_MCN_AND_ISRC_KEY]);
        subGroup.writeEntry(PROFILE_MODEL_LOG_KEY, cache[i][PROFILE_MODEL_LOG_KEY]);
        subGroup.writeEntry(PROFILE_MODEL_LOG_NAME_KEY, cache[i][PROFILE_MODEL_LOG_NAME_KEY]);
        subGroup.writeEntry(PROFILE_MODEL_LOG_WRITE_TIMESTAMPS_KEY, cache[i][PROFILE_MODEL_LOG_WRITE_TIMESTAMPS_KEY]);
        ...
        subGroup.writeEntry(PROFILE_MODEL_COLUMN_ENCODER_OPUSENC_PARAMETERS_KEY, cache[i][PROFILE_MODEL_COLUMN_ENCODER_OPUSENC_PARAMETERS_KEY]);
