...
enum Type { FirstSector = 0, LastSector, SessionNumber, TrackNumber, FirstTrackNumber, LastTrackNumber, Format, DataMode, PreEmphasis, CopyPermitted, MCN, ISRC, ChecksumCRC32, TrackIndices, Invalid };

enum TrackFormat { AUDIO, DATA, UNKNOWN_FORMAT };
enum TrackDataMode { MODE1, MODE2, UNKNOWN_DATAMODE };
