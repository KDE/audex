...
void Metadata::setCDDBCategory(const QString &category)
{
    ...
    validCategories << QStringLiteral(u"blues")
                    << QStringLiteral(u"classical")
                    << QStringLiteral(u"country")
                    << QStringLiteral(u"data")
                    << QStringLiteral(u"folk")
                    << QStringLiteral(u"jazz")
                    << QStringLiteral(u"misc")
                    << QStringLiteral(u"newage")
                    << QStringLiteral(u"reggae")
                    << QStringLiteral(u"rock")
                    << QStringLiteral(u"soundtrack");
...
void Metadata::setCDNum(const int n)
{
    set(Discnumber, n);
}

int Metadata::cdNum() const
{
    if (isMultiDisc())
