...
QByteArray readCD(const int deviceHandle, ErrorCode &errcode, const int firstSector, const int len, const int c2_err_ptrs = 0x00, const int subchannelData = 0x00);
