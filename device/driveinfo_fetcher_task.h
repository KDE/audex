...
#ifndef DRIVEINFO_FETCHER_TASK_H
#define DRIVEINFO_FETCHER_TASK_H
...
class DriveInfoFetcherTask : public Task
{
    Q_OBJECT

public:
    DriveInfoFetcherTask(const QString &driveUDI) : Task(driveUDI) {}

Q_SIGNALS:
    void finished(const QString& driveUDI, const bool successful, const DriveInfo& driveInfo = DriveInfo());
